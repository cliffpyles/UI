...
export default function DataDisplay() {
  ...
  return (
    <section>
      ...
      <Demo title="EmptyState" description="No-data, no-results, and restricted variants.">
      ...
      <Demo title="ErrorState" description="Error with retry, details, and retrying state.">
        <Box display="flex" gap="4" style={{ flexWrap: "wrap" }}>
      ...
      <Demo title="ProgressBar" description="Determinate and indeterminate bars with variants.">
      ...
      <Demo title="Table" description="Sortable headers, numeric columns, body, and footer.">
